                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full  sm:justify-between">
                    ...
                    <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                      ...
                      <div className="flex items-center space-x-4">
                        <p className="text-sm">{product?.price ? (product.price * product.quantity).toLocaleString("en-US", { style: "currency", currency: "USD" }) : 'N/A'}
                        </p>
              ...
              <div className="flex justify-between">
                ...
                <div className="">
                  <p className="mb-1 text-lg font-bold">
                    {typeof total === 'number'
                    ? total.toLocaleString("en-US", { style: "currency", currency: "USD" }) + 10
                    : "N/A"}</p>
                  <p className="text-sm text-gray-700">including VAT</p>
                </div>
              </div>
              <button className="mt-6 w-full rounded-md py-4 bg-blue-500 font-medium text-blue-50 hover:bg-blue-600">Check out</button>
            </div>
          </div>
        </div>

      ) : (
          <h1 className="mt-28 text-center">Your backet is empty</h1>
      )
    }
    </>
  )
